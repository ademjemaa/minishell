...
run_test 'export !' 
run_test 'export +' 
run_test 'export testvar ; export | grep testvar'
run_test 'export testvar= ; export | grep testvar'
run_test 'export testvar=0 ; export | grep testvar'
run_test 'export testvar=1234567 ; export | grep testvar'
run_test 'export testvar=lala ; export | grep testvar'
run_test 'export testvar=lala%lala ; export | grep testvar'
run_test 'export testvar=@lala ; export | grep testvar'
run_test 'export testvar10 ; export | grep testvar10'
run_test 'export testvar10= ; export | grep testvar10'
run_test 'export testvar10=10 ; export | grep testvar10'
run_test 'export _testvar ; export | grep _testvar'
run_test 'export _testvar= ; export | grep _testvar'
run_test 'export _testvar=10 ; export | grep _testvar'
run_test 'export _testvar=lala ; export | grep _testvar'
run_test 'export _testvar=lala10 ; export | grep _testvar'
run_test 'export _testvar10 ; export | grep _testvar10'
run_test 'export _testvar10= ; export | grep _testvar10'
run_test 'export _testvar10=lala ; export | grep _testvar10'
run_test 'export _testvar10=10; export | grep _testvar10'
run_test 'export _testvar10=lala10 ; export | grep _testvar10'
run_test 'export testvar=10 ; export testvar=20 ; export | grep testvar'
